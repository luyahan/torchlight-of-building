...
export const CHEST_ARMOR_INT_SUFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Advanced",
    "tier": "0",
    "template": "Inflicts Cold Infiltration when dealing damage. Interval for each enemy: 1s\n When Minions deal damage, inflicts Cold Infiltration . Interval for each enemy: 1s\n +{0}% Cold Infiltration Effect",
    "valueRanges": [
      {
        "min": 40,
        "max": 60
    ...
    "rawAffix": "Inflicts Cold Infiltration when dealing damage. Interval for each enemy: `1`s<> When Minions deal damage, inflicts Cold Infiltration . Interval for each enemy: `1`s<> `+(40-60)`% Cold Infiltration Effect"
  },
  {
    "equipmentTypeKey": "chest_armor_int",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "rawAffix": "Inflicts Cold Infiltration when dealing damage. Interval for each enemy: `1`s<> When Minions deal damage, inflicts Cold Infiltration . Interval for each enemy: `1`s<> `+(10-30)`% Cold Infiltration Effect"
  },
  {
    "equipmentTypeKey": "chest_armor_int",
    "equipmentSlot": "Chest Armor",
...
export type ChestArmorIntSuffixAffix = (typeof CHEST_ARMOR_INT_SUFFIX_AFFIXES)[number];
