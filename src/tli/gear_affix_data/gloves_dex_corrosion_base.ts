...
export const GLOVES_DEX_CORROSION_BASE_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% chance to Mark the target on hit",
    "valueRanges": [
      {
        "min": 15,
        "max": 20
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% chance to cause Blinding on hit",
    "valueRanges": [
      {
        "min": 15,
        "max": 20
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% chance to inflict Paralysis on hit",
    "valueRanges": [
      {
        "min": 15,
        "max": 20
...
export type GlovesDexCorrosionBaseAffix = (typeof GLOVES_DEX_CORROSION_BASE_AFFIXES)[number];
