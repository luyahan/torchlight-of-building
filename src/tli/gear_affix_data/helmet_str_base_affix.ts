...
export const HELMET_STR_BASE_AFFIX_AFFIXES = [
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Armor Effective Rate for Non-Physical Damage",
    "valueRanges": [
      {
        "min": 13,
        "max": 14
  ...
  },
  {
    ...
    "rawAffix": "`+(5-7)`% Armor DMG Mitigation Penetration<> `+(5-7)`% Armor DMG Mitigation Penetration for Minions"
  },
  {
    "equipmentTypeKey": "helmet_str",
    "equipmentSlot": "Helmet",
  ...
  },
  {
    ...
    "rawAffix": "`+(6-8)`% Elemental and Erosion Resistance Penetration<> `+(6-8)`% Elemental and Erosion Resistance Penetration for Minions"
  },
  {
    "equipmentTypeKey": "helmet_str",
    "equipmentSlot": "Helmet",
  ...
  },
  {
    ...
    "valueRanges": [],
    "rawAffix": "When dealing damage, inflicts Fire Infiltration . Interval for each enemy: `1`s<> When Minions deal damage, inflicts Fire Infiltration . Interval for each enemy: `1`s"
  },
  {
    "equipmentTypeKey": "helmet_str",
    "equipmentSlot": "Helmet",
...
export type HelmetStrBaseAffixAffix = (typeof HELMET_STR_BASE_AFFIX_AFFIXES)[number];
