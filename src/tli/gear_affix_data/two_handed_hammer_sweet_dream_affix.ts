...
export const TWO_HANDED_HAMMER_SWEET_DREAM_AFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "rawAffix": "`+(14-16)`% additional damage when a Skill consumes Demolisher Charge"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
...
export type TwoHandedHammerSweetDreamAffixAffix = (typeof TWO_HANDED_HAMMER_SWEET_DREAM_AFFIX_AFFIXES)[number];
