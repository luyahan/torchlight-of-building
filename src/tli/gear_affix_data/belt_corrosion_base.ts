...
export const BELT_CORROSION_BASE_AFFIXES = [
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "{0}% additional Damage Over Time taken when a Restoration Skill is active",
    "valueRanges": [
      {
        "min": -50,
        "max": -40
    ...
    "rawAffix": "`(-50--40)`% additional Damage Over Time taken when a Restoration Skill is active"
  },
  {
    "equipmentTypeKey": "belt",
    "equipmentSlot": "Trinket",
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Charged Flames Aura",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Cruelty Aura Effect",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Electric Conversion Aura",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Frigid Domain Aura Effect",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Precise Projectiles Aura effect",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Radical Order Aura Effect",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Spell Amplification Aura",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Weapon Amplification Aura",
    "valueRanges": [
      {
        "min": 20,
        "max": 30
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "Owns 1additional stack(s) of Fortitude",
    "valueRanges": [],
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "Restoration Skills: {0}% Restoration Duration",
    "valueRanges": [
      {
        "min": -20,
        "max": -15
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "Restoration Skills: +{0}% restoration effect",
    "valueRanges": [
      {
        "min": 30,
        "max": 40
...
export type BeltCorrosionBaseAffix = (typeof BELT_CORROSION_BASE_AFFIXES)[number];
