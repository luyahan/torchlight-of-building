...
export const ONE_HANDED_HAMMER_SWEET_DREAM_AFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "rawAffix": "`+(12-16)`% additional damage when a Skill consumes Demolisher Charge"
  },
  {
    "equipmentTypeKey": "one_handed_hammer",
    "equipmentSlot": "One-Handed",
...
export type OneHandedHammerSweetDreamAffixAffix = (typeof ONE_HANDED_HAMMER_SWEET_DREAM_AFFIX_AFFIXES)[number];
