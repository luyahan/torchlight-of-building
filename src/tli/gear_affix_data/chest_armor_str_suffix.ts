...
export const CHEST_ARMOR_STR_SUFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "0",
    "template": "Regenerates {0}% Life per second when taking Damage Over Time",
    "valueRanges": [
      {
        "min": 9,
        "max": 10
    ...
    "rawAffix": "Regenerates `(9-10)`% Life per second when taking Damage Over Time"
  },
  {
    "equipmentTypeKey": "chest_armor_str",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "rawAffix": "Regenerates `(7-8)`% Life per second when taking Damage Over Time"
  },
  {
    "equipmentTypeKey": "chest_armor_str",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "craftingPool": "Advanced",
    "tier": "0",
    "template": "When dealing damage, inflicts Fire Infiltration . Interval for each enemy: 1s\n When Minions deal damage, inflicts Fire Infiltration . Interval for each enemy: 1s\n +{0}% Fire Infiltration Effect",
    "valueRanges": [
      {
        "min": 40,
        "max": 60
    ...
    "rawAffix": "When dealing damage, inflicts Fire Infiltration . Interval for each enemy: `1`s<> When Minions deal damage, inflicts Fire Infiltration . Interval for each enemy: `1`s<> `+(40-60)`% Fire Infiltration Effect"
  },
  {
    "equipmentTypeKey": "chest_armor_str",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "rawAffix": "When dealing damage, inflicts Fire Infiltration . Interval for each enemy: `1`s<> When Minions deal damage, inflicts Fire Infiltration . Interval for each enemy: `1`s<> `+(10-30)`% Fire Infiltration Effect"
  },
  {
    "equipmentTypeKey": "chest_armor_str",
    "equipmentSlot": "Chest Armor",
...
export type ChestArmorStrSuffixAffix = (typeof CHEST_ARMOR_STR_SUFFIX_AFFIXES)[number];
