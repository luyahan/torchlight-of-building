...
export const TWO_HANDED_AXE_PREFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "0",
    "template": "+{0}% additional Trauma Damage",
    "valueRanges": [
      {
        "min": 61,
        "max": 78
  ...
  },
  {
    ...
    "craftingPool": "Basic",
    "tier": "0",
    "template": "Reaps (0.37-0.48)s of Trauma Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    "valueRanges": [],
    "rawAffix": "Reaps `(0.37-0.48)`s of Trauma Damage when dealing Damage Over Time. The effect has a `1`s cooldown against the same target"
  },
  {
    "equipmentTypeKey": "two_handed_axe",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "craftingPool": "Basic",
    "tier": "1",
    "template": "Reaps (0.25-0.36)s of Trauma Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    "valueRanges": [],
    "rawAffix": "Reaps `(0.25-0.36)`s of Trauma Damage when dealing Damage Over Time. The effect has a `1`s cooldown against the same target"
  }
] as const satisfies readonly BaseGearAffix[];

export type TwoHandedAxePrefixAffix = (typeof TWO_HANDED_AXE_PREFIX_AFFIXES)[number];
