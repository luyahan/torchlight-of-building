...
export const TWO_HANDED_HAMMER_SUFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "0",
    "template": "+{0}% additional Melee Damage",
    "valueRanges": [
      {
        "min": 61,
        "max": 78
  ...
  },
  {
    ...
    "rawAffix": "`+60`% Steep Strike chance.<> `+(49-62)`% additional Steep Strike Damage"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "1",
    "template": "+46% Steep Strike chance.\n +{0}% additional Steep Strike Damage",
    "valueRanges": [
      {
        "min": 35,
        "max": 48
    ...
    "rawAffix": "`+46`% Steep Strike chance.<> `+(35-48)`% additional Steep Strike Damage"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "rawAffix": "`+(66-94)`% Attack and Cast Speed<> `+(66-94)`% Minion Attack and Cast Speed"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "rawAffix": "`+(51-72)`% Attack and Cast Speed<> `+(51-72)`% Minion Attack and Cast Speed"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "craftingPool": "Basic",
    "tier": "0",
    "template": "+{0}% additional Attack Damage after standing still for 0.1s. -20% additional Attack Speed",
    "valueRanges": [
      {
        "min": 101,
        "max": 124
    ...
    "rawAffix": "`+(101-124)`% additional Attack Damage after standing still for 0.1s. `-20`% additional Attack Speed"
  },
  {
    "equipmentTypeKey": "two_handed_hammer",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "rawAffix": "`+(80-100)`% additional Attack Damage after standing still for 0.1s. `-20`% additional Attack Speed"
  }
] as const satisfies readonly BaseGearAffix[];

export type TwoHandedHammerSuffixAffix = (typeof TWO_HANDED_HAMMER_SUFFIX_AFFIXES)[number];
