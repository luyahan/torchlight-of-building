...
export const SHIELD_INT_SWEET_DREAM_AFFIX_AFFIXES = [
  {
    ...
    "craftingPool": "",
    "tier": "0",
    "template": "+{0}% Max Elemental and Erosion Resistance",
    "valueRanges": [
      {
        "min": 4,
        "max": 5
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "1",
    "template": "+100% chance to gain a stack of Fortitude when using a Melee Skill",
    "valueRanges": [],
    "rawAffix": "`+100`% chance to gain a stack of Fortitude when using a Melee Skill"
  },
  {
    "equipmentTypeKey": "shield_int",
    "equipmentSlot": "Shield",
...
export type ShieldIntSweetDreamAffixAffix = (typeof SHIELD_INT_SWEET_DREAM_AFFIX_AFFIXES)[number];
