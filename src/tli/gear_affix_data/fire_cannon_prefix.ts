...
export const FIRE_CANNON_PREFIX_AFFIXES = [
  ...
  },
  {
    ...
    tier: "0",
    template:
      "Reaps (0.37-0.48)s of Wilt Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    valueRanges: [],
    rawAffix:
  ...
  },
  {
    ...
    tier: "1",
    template:
      "Reaps (0.25-0.36)s of Wilt Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    valueRanges: [],
    rawAffix:
