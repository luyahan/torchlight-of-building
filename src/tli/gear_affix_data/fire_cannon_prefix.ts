...
export const FIRE_CANNON_PREFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "0",
    "template": "+{0}% additional Wilt Damage",
    "valueRanges": [
      {
        "min": 61,
        "max": 78
    ...
    "rawAffix": "`+(61-78)`% additional Wilt Damage"
  },
  {
    "equipmentTypeKey": "fire_cannon",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "rawAffix": "`+(43-60)`% additional Wilt Damage"
  },
  {
    "equipmentTypeKey": "fire_cannon",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "craftingPool": "Basic",
    "tier": "0",
    "template": "Reaps (0.37-0.48)s of Wilt Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    "valueRanges": [],
    "rawAffix": "Reaps `(0.37-0.48)`s of Wilt Damage when dealing Damage Over Time. The effect has a `1`s cooldown against the same target"
  },
  {
    "equipmentTypeKey": "fire_cannon",
    "equipmentSlot": "Two-Handed",
  ...
  },
  {
    ...
    "craftingPool": "Basic",
    "tier": "1",
    "template": "Reaps (0.25-0.36)s of Wilt Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    "valueRanges": [],
    "rawAffix": "Reaps `(0.25-0.36)`s of Wilt Damage when dealing Damage Over Time. The effect has a `1`s cooldown against the same target"
  }
