...
export const ONE_HANDED_AXE_PREFIX_AFFIXES = [
  ...
  },
  {
    ...
    tier: "0",
    template:
      "Reaps (0.19-0.24)s of Trauma Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    valueRanges: [],
    rawAffix:
  ...
  },
  {
    ...
    tier: "1",
    template:
      "Reaps (0.13-0.18)s of Trauma Damage when dealing Damage Over Time. The effect has a 1s cooldown against the same target",
    valueRanges: [],
    rawAffix:
