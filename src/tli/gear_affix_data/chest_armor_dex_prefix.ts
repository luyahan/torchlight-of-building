...
export const CHEST_ARMOR_DEX_PREFIX_AFFIXES = [
  {
    ...
    "tier": "0",
    "template": "-45% additional Damage Over Time taken when having at least 50000Evasion",
    "valueRanges": [],
    "rawAffix": "`-45`% additional Damage Over Time taken when having at least `50000`Evasion"
  },
  {
    "equipmentTypeKey": "chest_armor_dex",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "rawAffix": "Converts `(16-20)`% of Physical Damage taken to Lightning Damage"
  },
  {
    "equipmentTypeKey": "chest_armor_dex",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "1",
    "template": "-40% additional Damage Over Time taken when having at least 50000Evasion",
    "valueRanges": [],
    "rawAffix": "`-40`% additional Damage Over Time taken when having at least `50000`Evasion"
  },
  {
    "equipmentTypeKey": "chest_armor_dex",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "rawAffix": "Converts `(12-15)`% of Physical Damage taken to Lightning Damage"
  },
  {
    "equipmentTypeKey": "chest_armor_dex",
    "equipmentSlot": "Chest Armor",
  ...
  },
  {
    ...
    "craftingPool": "Ultimate",
    "tier": "1",
    "template": "Enemies have a {0}% chance to explode when defeated by an Attack or Spell, dealing Secondary Physical Damage equal to {1}% of their Max Life to enemies within a 4m radius",
    "valueRanges": [
      {
        "min": 10,
        "max": 15
    ...
    "rawAffix": "Enemies have a `(10-15)`% chance to explode when defeated by an Attack or Spell, dealing Secondary Physical Damage equal to `(15-25)`% of their Max Life to enemies within a `4`m radius"
  },
  {
    "equipmentTypeKey": "chest_armor_dex",
    "equipmentSlot": "Chest Armor",
...
export type ChestArmorDexPrefixAffix = (typeof CHEST_ARMOR_DEX_PREFIX_AFFIXES)[number];
