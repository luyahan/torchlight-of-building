...
export const ONE_HANDED_AXE_SWEET_DREAM_AFFIX_AFFIXES = [
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "1",
    "template": "+{0}% additional damage against Traumatized enemies",
    "valueRanges": [
      {
        "min": 6,
        "max": 8
  ...
  },
  {
    ...
    "craftingPool": "",
    "tier": "1",
    "template": "+{0}% additional Steep Strike Damage",
    "valueRanges": [
      {
        "min": 6,
        "max": 9
...
export type OneHandedAxeSweetDreamAffixAffix = (typeof ONE_HANDED_AXE_SWEET_DREAM_AFFIX_AFFIXES)[number];
